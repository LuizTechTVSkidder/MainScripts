...
do
	...
	function Utility:DraggingEnabled(frame, parent, allowed)
		...
		frame.InputBegan:Connect(function(input)
			if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch or not allowed() then return end
		...
		frame.InputChanged:Connect(function(input)
			if input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch or allowed() then
				dragInput = input
			end
		end)
