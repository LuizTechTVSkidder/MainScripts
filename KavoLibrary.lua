...
local themeStyles = {
    ...
    BlueTheme = {
        SchemeColor = Color3.fromRGB(0,204,255),
        Background = Color3.fromRGB(0, 0, 0),
        Header = Color3.fromRGB(0, 0, 0),
        TextColor = Color3.fromRGB(255,255,255),
        ElementColor = Color3.fromRGB(20, 20, 20)
    ...
    function Tabs:NewTab(tabName)
        ...
        coroutine.wrap(function()
            ...
            function Elements:NewTextBox(tname, tTip, callback)
                ...
                textboxElement.Font = Enum.Font.Code
                textboxElement.Text = ""
                ...
                function Elements:NewToggle(tname, nTip, callback)
                    ...
                    toggleElement.Font = Enum.Font.Code
                    toggleElement.Text = ""
            ...
            function Elements:NewSlider(slidInf, slidTip, maxvalue, minvalue, callback)
                ...
                sliderElement.Font = Enum.Font.Code
                sliderElement.Text = ""
            ...
            function Elements:NewDropdown(dropname, dropinf, list, callback)
                ...
                itemTextbox.Font = Enum.Font.Code
                ...
                for i,v in next, list do
                    ...
                    optionSelect.Font = Enum.Font.Code
                    optionSelect.Text = "  "..v
            ...
            function Elements:NewKeybind(keytext, keyinf, first, callback)
                ...
                keybindElement.Font = Enum.Font.Code
                keybindElement.Text = ""
            ...
            function Elements:NewColorPicker(colText, colInf, defcolor, callback)
                ...
                colorElement.Font = Enum.Font.Code
                colorElement.Text = ""
